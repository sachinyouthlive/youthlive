...
import com.app.youthlive.timelineProfilePOJO.Data;
...
/*
    ...
    public class CoverPager extends FragmentStatePagerAdapter {
        ...
        List<com.app.youthlive.timelineProfilePOJO.CoverImage> list = new ArrayList<>();

        public CoverPager(FragmentManager fm, List<com.app.youthlive.timelineProfilePOJO.CoverImage> list) {
            super(fm);
            this.list = list;
        }
