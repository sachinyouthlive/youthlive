...
public class RedeemCoins extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Exchange to Money");
        ...
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nVal > limit)
                {
                    Toast.makeText(RedeemCoins.this, "Max. value reached", Toast.LENGTH_SHORT).show();
                }
                else
                {
        ...
        minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nVal < 0)
                {
                    Toast.makeText(RedeemCoins.this, "Min. value reached", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    diamm = nVal / param;
        ...
        redeem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<loginResponseBean> call = b.getRetrofit().redeemCoins(SharePreferenceUtils.getInstance().getString("userId") , display.getText().toString() , String.valueOf(diamm));
                ...
                call.enqueue(new Callback<loginResponseBean>() {
                    ...
                    public void onResponse(@NonNull Call<loginResponseBean> call, @NonNull Response<loginResponseBean> response) {
                        ...
                        {
                            Toast.makeText(RedeemCoins.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                            getCoinsData();
                        }
