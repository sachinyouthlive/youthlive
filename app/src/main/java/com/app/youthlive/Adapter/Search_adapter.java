...
import com.app.youthlive.Activitys.SearchActivity;
...
import com.app.youthlive.searchlistPOJO.Datum;
...
public class Search_adapter extends RecyclerView.Adapter<Search_adapter.searchadapter> {
    ...
    @Override
    public searchadapter onCreateViewHolder(ViewGroup parent, int viewType) {
        con = (SearchActivity) context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.searchlist_recycler, parent, false);
    ...
    public class searchadapter extends RecyclerView.ViewHolder {
        ...
        public searchadapter(View itemView) {
            super(itemView);
