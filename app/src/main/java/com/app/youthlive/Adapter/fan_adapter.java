...
import com.app.youthlive.Activitys.FanActivity;
...
public class fan_adapter extends RecyclerView.Adapter<fan_adapter.fanadapter> {
    ...
    public fan_adapter(Context context, List<Datum> list) {
        this.list = list;
    ...
    @Override
    public fanadapter onCreateViewHolder(ViewGroup parent, int viewType) {
        con = (FanActivity) context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.fan_recycler, parent, false);
        return new fanadapter(view);
    }
    ...
    public void onBindViewHolder(final fanadapter holder, int position) {
        ...
        holder.relativefan.setOnClickListener(new View.OnClickListener() {
            @Override
...
*/
    ...
    public class fanadapter extends RecyclerView.ViewHolder {
