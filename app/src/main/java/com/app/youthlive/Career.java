...
public class Career extends Fragment {
    ...
    List<com.app.youthlive.loginResponsePOJO.Career> list;
    EducationAdapter adapter;
    FloatingActionButton add;
    PersonalInfo per;
    String userId;

    public void setData(List<com.app.youthlive.loginResponsePOJO.Career> list) {
        this.list = list;
    }
    ...
    public class EducationAdapter extends RecyclerView.Adapter<EducationAdapter.ViewHolder> {
        List<com.app.youthlive.loginResponsePOJO.Career> list = new ArrayList<>();
        Context context;

        public EducationAdapter(Context context, List<com.app.youthlive.loginResponsePOJO.Career> list) {
            this.list = list;
            this.context = context;
        }

        public void setGridData(List<com.app.youthlive.loginResponsePOJO.Career> list) {
            this.list = list;
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            final com.app.youthlive.loginResponsePOJO.Career item = list.get(position);
                ...
                public void onClick(View v) {
                    ...
                    delete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Call<deleteCareerBean> call = b.getRetrofit().deleteCareer(SharePreferenceUtils.getInstance().getString("userId"), item.getCareerId());
                                ...
                                if (p.length() > 0) {
                                    ...
                                    if (f.length() > 0) {
                                        ...
                                        if (tt.length() > 0) {
                                            ...
                                            Call<editCareerBean> call = b.getRetrofit().editCareer(SharePreferenceUtils.getInstance().getString("userId"), p, t, f, tt, item.getCareerId());
