...
public class Education extends Fragment {
    ...
    List<com.app.youthlive.loginResponsePOJO.Education> list;
    ...
    public void setData(List<com.app.youthlive.loginResponsePOJO.Education> list) {
        this.list = list;
    }
    ...
    public class EducationAdapter extends RecyclerView.Adapter<EducationAdapter.ViewHolder> {
        List<com.app.youthlive.loginResponsePOJO.Education> list = new ArrayList<>();
        Context context;

        public EducationAdapter(Context context, List<com.app.youthlive.loginResponsePOJO.Education> list) {
            this.list = list;
            this.context = context;
        }

        public void setGridData(List<com.app.youthlive.loginResponsePOJO.Education> list) {
            this.list = list;
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            final com.app.youthlive.loginResponsePOJO.Education item = list.get(position);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    edu.setText(item.getSchoolTitle());

                    final EditText year = dialog.findViewById(R.id.year);

                    year.setText(item.getTime());
