...
public abstract class GoCoderSDKActivityBase extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "GoCoderSDKActivityBase.java", Toast.LENGTH_SHORT).show();
        if (sGoCoderSDK == null) {
        ...
        if (sGoCoderSDK != null) {
            ...
            mWZBroadcastConfig.setVideoBitRate(1200);
            // Create a configuration instance
// Set the frame rate to 15 fps
            mWZBroadcastConfig.setVideoFramerate(30);
// Set the bitrate to 2500 bps
            mWZBroadcastConfig.setVideoBitRate(3000);
            mWZBroadcastConfig.setAudioSampleRate(22100);
