...
public class Education extends Fragment {
    ...
    List<com.yl.youthlive.loginResponsePOJO.Education> list;
    ...
    public class EducationAdapter extends RecyclerView.Adapter<EducationAdapter.ViewHolder> {
        List<com.yl.youthlive.loginResponsePOJO.Education> list = new ArrayList<>();
        Context context;

        public EducationAdapter(Context context, List<com.yl.youthlive.loginResponsePOJO.Education> list) {
            this.list = list;
            this.context = context;
        }

        public void setGridData(List<com.yl.youthlive.loginResponsePOJO.Education> list) {
            this.list = list;
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            final com.yl.youthlive.loginResponsePOJO.Education item = list.get(position);
